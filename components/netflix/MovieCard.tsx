  ...
  return (
    <div className="group relative h-[40vw] min-w-[150px] cursor-pointer bg-zinc-900 md:h-[12vw] md:min-w-[240px]">
      <Link href={watchUrl}>
        ...
        />
        <div className="absolute top-2 left-2 z-10 flex h-6 w-4 items-center justify-center bg-red-600 text-[10px] font-black text-white rounded-sm sm:group-hover:opacity-0">
          N
        </div>
      </Link>
      ...
      <div className="absolute inset-0 z-10 hidden scale-0 bg-zinc-900 opacity-0 transition duration-300 group-hover:scale-110 group-hover:opacity-100 sm:block rounded-md shadow-xl pointer-events-none group-hover:pointer-events-auto">
        ...
        <div className="p-2 lg:p-4">
          <div className="flex items-center gap-3">
            ...
            <button className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-white transition hover:border-neutral-300 lg:h-10 lg:w-10" aria-label="Add to My List">
              <Plus className="h-4 w-4 text-white lg:h-6 lg:w-6" />
            </button>
            <button className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-white transition hover:border-neutral-300 lg:h-10 lg:w-10" aria-label="I like this">
              <ThumbsUp className="h-4 w-4 text-white lg:h-6 lg:w-6" />
            </button>
            <button className="ml-auto flex h-6 w-6 items-center justify-center rounded-full border-2 border-white transition hover:border-neutral-300 lg:h-10 lg:w-10" aria-label="More info">
