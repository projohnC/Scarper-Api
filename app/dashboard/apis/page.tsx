            ...
            <DialogContent>
              ...
              {createdKey ? (
                <div className="space-y-4">
                  ...
                  <Button onClick={() => copyToClipboard(createdKey)} className="w-full" variant="outline">
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Create your API key to start using the scraper API.
                </p>
              </div>
              ...
              return (
                <Card key={key.id} className="p-6">
                      ...
                      <div className="space-y-1 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="outline"
                            className={
                              key.isActive ? "text-green-600 border-green-600" : "text-red-600 border-red-600"
                            }
                          >
                  ...
                  <div className="mt-4 pt-4 border-t flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="text-xs bg-muted px-3 py-1.5 rounded">{key.key}</code>
